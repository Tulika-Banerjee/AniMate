/***************************************
Animation: Bounce in place
 Working: Once clicked, the component follows
 through on the click and ‘bounces’ back into its original position.
...
public class Bounce {
    ...
    public static void Bounce(JComponent component, Point location, int numIterationsLimit, int sec)
    {
        ...
        timer = new Timer(seconds, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (numIterations++ >= numIterationsLimit) {
                    ...
                    //The location of the component is updated to show a bounce
                    component.setLocation(startX,
                            startY+ numIterations * (startY - startX)/numIterationsLimit);
                    //The location of the component is reverted to its original position at the end of bounce
                    component.setLocation(startX,
                            endY- numIterations * (endY - startY)/numIterationsLimit);
                }
            }
        });
        timer.start();
    ...
    /*public static void main(String[] args) {
            ...
            public void keyPressed(KeyEvent e) {
                if(e.getKeyCode()==KeyEvent.VK_ENTER)
                {
                    ...
                    if(!password.equals(passPhrase)){
                        ...
                        Bounce.Bounce(text,location,5,50);
                    }
        ...
        submit.addMouseListener(new MouseListener() {
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                Bounce.Bounce(submit,location,5,50);
