/***************************************
 Animation: Animate Sheet Dialog
 Working: A dialog or modal rolls down from the title bar
 and rolls back up

 Animation Principles: Solid Drawing, Motion Blur
 Code referred from Swing Hacks by Joshua Marinacci and Chris Adamson Hack#45 with modifications
 ***************************************/
